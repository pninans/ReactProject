...
function App() {
  ...
  const handleEmailClick = () => {
    window.open("https://mail.google.com/mail/?view=cm&to=p0504155494@gmail.com&su=Question/Comment&body=Dear Site Administrator");
  };
  ...
  return (
   ...
   />
      ...
      >
        <p style={{ marginRight: "10px " }}>The site was developed by Pnina Ansbacher 12.2023        <IconButton onClick={handleEmailClick}>
          <EmailIcon />
        </IconButton></p>
